...
function Slider() {
  ...
  return (
    <div className="main-box">
        <div className="image-display"> <img src={images[number].src} /></div>
        <button onClick={handlePrev} className="next-btn"><FcNext /></button><br />
        <button onClick={handleNext} className="prev-btn"><FcPrevious /></button><br />
